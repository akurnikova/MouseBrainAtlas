...
stacks_moving = ['RV2_R'] #['RV16','RV4','RV13','RV14','RV15','RV19']['RV9','RV10','RV7','RV8','RV12']
...
def run_aligner(stack_moving,stack_fixed,warp_setting, showplots = 'off', save = 'on'):
    ...
    aligner.set_centroid(centroid_m='structure_centroid', centroid_f='structure_centroid', 
                         indices_m=[aligner_parameters['structure_to_label_moving']['RN_R']])
    ...
    #                                     init_T=grid_search_T, 
                                          affine_scaling_limits=(.999, 1.001)
                                        )
