...
fig_title = '/home/asya/Documents/Yuncong_code/Figures_code/Atlas_figs/RN0_S.pdf'

#include_stacks = {'RV15','RV16'}
include_stacks = {'RV4','RV14','RV13','RV19'}
...
fp = DataManager.get_mesh_filepath(stack_m='Rat_brainstem_atlas', structure='RN_R')
...
if dim1 == 0 and dim2 == 1: #Sagittal
    for orig in np.arange(-100, 0, 10):
...
if dim1 == 2 and dim2 == 1: #Coronal        
    for orig in np.arange(250,400,10):
        contour_points,order, _ = polydata_cut(mesh, origin=(0,0,0),
...
for stack in include_stacks:
    ...
    tf_parameter_dict = load_alignment_parameters_v3(stack_f='Rat_brainstem_atlas', stack_m=stack, warp_setting=24, 
